...
function unione(string1, string2) {
  let primiDue = string1.substring(0, 2);
  let ultimiTre = string2.slice(-3);
  let unioneStringa = primiDue + ultimiTre;
  let maiuscolo = unioneStringa.toUpperCase();
...
function calcolaSum() {
  let somma = numeri2.reduce((tot, curr) => tot + curr, 0);
  return somma;
}
console.log(somma2);
